...
function Fitness(){
    return(
        <div>
            ...
            <Container fluid>
  <Row>
  <Col lg = {4}><img className = "fitnesspic" src = {p90x}></img>
            </Col>
  <Col lg = {4}> <p className= "align">
    ...
    <Col lg = {4}><img className = "fitnesspic" src = {past}></img></Col>
  </Row>
  </Container>
  <Container fluid>
  <Row>
  ...
  <Col lg = {4}> <p className = "align">
                The journey, however, started with a lot of pushback from my parents' friends. They all believed I was too young to be working out
                and that I could really hurt myself in the process. Thankfully, my parents trusted me. From my very first workout video to now, my life
                has found a new meaning consisting of healthy eating, fitness, and a strong commitment to achieving my goals.
                </p></Col>
    <Col lg = {4}><img className = "fitnesspic" src = {recent}></img></Col>
  </Row>
  </Container>
        <MyFooter />
        </div>
